...
from core.probability_math import PERCENT_SCALE, PERCENT_TOTAL_UNITS, distribute_percent_units
...
class RandomProbabilityDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        from ui.dialog_style import apply_dialog_title, apply_dialog_note
